...
from .diffusion_model import UNet, DiffusionModel, offset_cosine_diffusion_schedule
...
def get_model(model_name="FCNN"):
    if model_name == "FCNN":
        ...
        # CIFAR-10 is RGB → 3 channels
        return EnergyModel()     
    elif model_name == "Diffusion":
        # CIFAR-10 is 32×32 RGB
        unet = UNet(image_size=32, num_channels=3, embedding_dim=32)
        return DiffusionModel(model=unet, schedule_fn=offset_cosine_diffusion_schedule)
